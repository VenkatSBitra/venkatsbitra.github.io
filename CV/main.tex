...
\resumeItem{Engineered a highly parameter-efficient \textbf{frame-level F0 and voicing extraction model with only $\approx$75K parameters} using Constant Q-Transform (CQT) features for lightweight deployment.}
